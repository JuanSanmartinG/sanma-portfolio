  ...
  return (
    <section id="contact" className="py-20 px-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-3xl font-bold text-white tracking-wide">Contact Me</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="space-y-4 font-mono text-sm text-gray-300 mb-6 md:mb-0">
          ...
          {status === 'SUCCESS' ? (
            <div className="text-center py-10 space-y-3">
              ...
              <button
                ...
                className="mt-4 text-xs font-mono text-gray-400 underline hover:text-white"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-sm text-gray-200 focus:outline-none focus:border-emerald-400 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-sm text-gray-200 focus:outline-none focus:border-emerald-400 transition-colors resize-none"
                ></textarea>
              </div>
              ...
              <button
                ...
                className="w-full bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-800 text-slate-950 font-semibold py-2.5 px-4 rounded-lg transition-colors duration-200 font-mono text-sm"
              >
